...
const dict = {
  zh: {
    ...
    "papers.search.hint": "输入英文关键词更准（OpenAlex 主要收录英文文献）。例：technology acceptance healthcare",
    ...
    "papers.results.count": "找到 {count} 篇论文（按引用数排序）",
  ...
  en: {
    ...
    "papers.search.hint": "English keywords work best (OpenAlex is mostly English). e.g., technology acceptance healthcare",
    ...
    "papers.results.count": "{count} papers found (sorted by citations)",
