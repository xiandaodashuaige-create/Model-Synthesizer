...
const dict = {
  zh: {
    ...
    "papers.bulk.title": "批量导入：从校园数据库 / Zotero / EndNote 导出文件",
    "papers.bulk.hint": "在知网、Web of Science、Scopus、谷歌学术、Zotero、EndNote 里勾选想要的论文 → 点『导出引文』选 BibTeX 或 RIS 格式 → 把文件拖进来或粘贴内容。系统会自动从中提取 DOI 并批量入库（一次最多 50 篇）。",
    "papers.bulk.uploadFile": "选择 .bib / .ris 文件",
  ...
  en: {
    ...
    "papers.bulk.title": "Bulk import: BibTeX / RIS from your library or reference manager",
    "papers.bulk.hint": "In CNKI, Web of Science, Scopus, Google Scholar, Zotero or EndNote, select the papers you want → Export citation as BibTeX or RIS → drop the file here or paste the content. We'll extract DOIs and import them in batch (up to 50 at a time).",
